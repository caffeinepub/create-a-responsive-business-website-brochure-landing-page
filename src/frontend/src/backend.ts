...
import type { ExternalBlob as _ExternalBlob, PhotoData as _PhotoData, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPhoto(arg0: string, arg1: ExternalBlob, arg2: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async clearPhotos(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearPhotos();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhotos(): Promise<Array<[string, PhotoData]>> {
        if (this.processError) {
            try {
    ...
    async removePhoto(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.removePhoto(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PhotoData_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoData): Promise<PhotoData> {
...
async function from_candid_tuple_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _PhotoData]): Promise<[string, PhotoData]> {
    return [
        value[0],
        await from_candid_PhotoData_n16(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[string, _PhotoData]>): Promise<Array<[string, PhotoData]>> {
